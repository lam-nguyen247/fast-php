...
class Storage {
	 ...
	 * @throws StorageException
	 */
	public function put(File $file, ?string $fileName = null, ?string $directory = null): ?string {
		try {
	 ...
	 * @throws AppException
	 */
	public function putAs(File $file, string $directory, string $fileName): ?string {
